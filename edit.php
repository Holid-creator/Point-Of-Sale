...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-6">
          <form action="<?= base_url('item/proccess') ?>" method="post">
            ...
            <?php if ($page == 'edit') {
              if ($row->img != null) { ?>
                <div style="margin-bottom: 5px;">
                  <img src="<?= base_url('uploads/product/' . $row->img) ?>" width="80px">
                </div>
            <?php }
            } ?>
            <input type="file" class="form-control mt-3" name="img" required>
