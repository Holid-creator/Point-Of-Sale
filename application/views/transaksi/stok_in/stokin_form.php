...
<section class="content">
  <div class="box">
    <div class="box-header">
      <div class="pull-right"><a href="<?= base_url('stok/in') ?>" class="btn btn-warning btn-flat"><i class="fa fa-undo"></i> Kembali</a></div>
    </div>
    <div class="box-body">
      <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
          <form action="<?= base_url('stok/proccess') ?>" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" name="detail" class="form-control" placeholder="Kalikan / Tambahakan / Etc" required>
            </div>
            <div class="form-group">
              ...
              <select name="supplier" class="form-control">
                ...
                <?php foreach ($supplier as $i => $data) { ?>
                  <option value="<?= $data->id_supp ?>"><?= $data->nama; ?></option>
                <?php } ?>
              </select>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-success btn-flat" name="in_add"><i class="fa fa-paper-plane"></i> Simpan</button>
